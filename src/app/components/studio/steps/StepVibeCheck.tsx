...
const vibeQuestions = [
  {
    ...
    options: [
      ...
      { label: 'This person is adventurous and bold', archetype: 'explorer' },
      { label: 'This person is passionate and inspiring', archetype: 'lover' },
      { label: 'This person brings joy and humor', archetype: 'jester' },
      { label: 'This person is in control and strategic', archetype: 'ruler' },
    ],
  },
  {
    id: 2,
    ...
    options: [
      ...
      { label: 'Inspiring transformation', archetype: 'magician' },
      { label: 'Creating emotional connection', archetype: 'lover' },
      { label: 'Leading and organizing', archetype: 'ruler' },
      { label: 'Motivating action and courage', archetype: 'hero' },
    ],
  },
  {
    id: 3,
    ...
    options: [
      ...
      { label: 'A sense of possibility', archetype: 'magician' },
      { label: 'Fun and entertainment', archetype: 'jester' },
      { label: 'Structure and clarity', archetype: 'ruler' },
      { label: 'New experiences and freedom', archetype: 'explorer' },
    ],
  },
  {
    id: 4,
    ...
    options: [
      ...
      { label: 'Connected and moved', archetype: 'lover' },
      { label: 'Energized and joyful', archetype: 'jester' },
      { label: 'Free and adventurous', archetype: 'explorer' },
      { label: 'Courageous and capable', archetype: 'hero' },
    ],
  },
  {
    id: 5,
    ...
    options: [
      ...
      { label: 'Visionary and transformative', archetype: 'magician' },
      { label: 'Passionate and heartfelt', archetype: 'lover' },
      { label: 'Commanding and strategic', archetype: 'ruler' },
      { label: 'Brave and empowering', archetype: 'hero' },
    ],
  },
  {
    id: 6,
    ...
    options: [
      ...
      { label: 'Breaking boundaries and exploring new territory', archetype: 'explorer' },
      { label: 'Bringing lightness and joy to the world', archetype: 'jester' },
      { label: 'Making a real difference in people\'s lives', archetype: 'caregiver' },
      { label: 'Disrupting outdated systems', archetype: 'rebel' },
    ],
  },
];
